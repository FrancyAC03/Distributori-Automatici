<?php
    ...
    $sql="SELECT Quantita FROM Contenere WHERE  IdDistributore = 4"; 
    ...
    <header class="ScriptHeader">
        <div class="rt-container">
            <div class="col-rt-12" style="float: left;">
                ...
                <img src="../../Distributori.grafica\Nicios%20Dispenser.png" style="width: 50%;">
            </div>
        </div>
    </header>
    <div class="container" style="position: absolute;top:505px;left: 1438px;">
        <form action="4nicios_dispenser.php" style="position: absolute;top:-60px;left: 150px;" method="Post" id="form">
